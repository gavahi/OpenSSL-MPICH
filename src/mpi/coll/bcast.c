...
/* void init_boringssl_siv(){

    unsigned char key_boringssl_siv [32] = {'a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z','a','b','c','d','e','f'};
               ...
               MPI_Comm comm , int KEY_mode)
{
	...
	if (rank == root) {
		...
		MPI_Bcast(ciphertext, blocktype+16, MPI_CHAR, 0, comm);
		...
		openssl_dec_core(ciphertext,0,buffer,0,blocktype);			
